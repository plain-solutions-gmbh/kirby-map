(function() {
  ...
  var _sfc_render = function render() {
    ...
    }), 1), _c("k-input", { ref: "name", attrs: { "type": "text", "theme": "field", "value": _vm.location.name, "before": _vm.$t("maps.field.geolocation.name") }, on: { "input": function($event) {
