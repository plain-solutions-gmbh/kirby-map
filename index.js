...
var _default = {
  ...
  computed: {
    ...
    marker: function marker() {
      return this.content.marker.map(function (a) {
        var imagesize = a.content.image.length > 0 ? a.content.image[0].info.split(" × ") : [0, 0];
        return {
    ...
    center: function center() {
      if (this.content.center) {
        ...
        var markerNode = this.field('marker').fieldsets.marker.tabs.content.fields.coors;
  ...
  created: function created() {
    ...
    mapboxScript.onload = function () {
      ...
      _this.$api.get('map/options').then(function (res) {
        _this.options = res;
  ...
  watch: {
    ...
    marker: {
      handler: function handler(value) {
        this.attachedPopup.forEach(function (marker) {
          return marker.remove();
        });
        this.attachedPopup = [];
        this.attachedMarker.forEach(function (marker) {
          return marker.remove();
        });
        this.attachedMarker = [];
  ...
  methods: {
    ...
    setMarker: function setMarker(markerdata) {
      ...
      if (markerdata) markerdata.forEach(function (marker) {
        if (marker.image) {
        ...
        var curMarker = new mapboxgl.Marker({
          anchor: marker.anchor || null,
          element: markerEl || null
        }).setLngLat([marker.lng, marker.lat]).addTo(_this2.map);

        _this2.attachedMarker.push(curMarker);

        if (marker.haspopup) {
          var curPopup = new mapboxgl.Popup({
            offset: parseInt(marker.popupoffset),
            focusAfterOpen: false
          }).setLngLat([marker.lng, marker.lat]);

          _this2.attachedPopup.push(curPopup);

          _this2.$api.post('map/converter', {
            markdown: marker.popup
          }).then(function (res) {
            curPopup.setHTML(res.html).addTo(_this2.map);
          });
        }
...
exports.default = _default;
        var $6ae045 = exports.default || module.exports;
      
      if (typeof $6ae045 === 'function') {
        $6ae045 = $6ae045.options;
      }
    
        /* template */
        Object.assign($6ae045, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6ae045', $6ae045);
          } else {
            api.reload('$6ae045', $6ae045);
          }
        }
...
},{"_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/Marker.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  computed: {
    ...
    coors: function coors() {
      if (this.content.coors) return this.content.coors.lat + "," + this.content.coors.lng;
      return "";
    }
  }
};
exports.default = _default;
        var $d2a752 = exports.default || module.exports;
      
      if (typeof $d2a752 === 'function') {
        $d2a752 = $d2a752.options;
      }
    
        /* template */
        Object.assign($d2a752, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "marker-item", on: { click: _vm.open } }, [
    _c("span", { staticClass: "img-wrapper" }, [
      _vm.img ? _c("img", { attrs: { src: _vm.img } }) : _vm._e()
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "desc-wrapper" }, [
      _c("p", [_vm._v(_vm._s(_vm.name || _vm.$t("empty")))]),
      _vm._v(" "),
      _c("p", [_vm._v(_vm._s(_vm.coors))])
    ])
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d2a752', $d2a752);
          } else {
            api.reload('$d2a752', $d2a752);
          }
        }
...
},{"_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/Geolocation.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    ...
    dropdownOptions: function dropdownOptions() {
      return this.geodata.map(function (el) {
        return {
          name: el.place_name,
  ...
  methods: {
    searchLocation: function searchLocation(e) {
      ...
      if (e.length > 0) {
        fetch('https://api.mapbox.com/geocoding/v5/mapbox.places/' + e + '.json?types=address,country,postcode,place,locality&limit=5&access_token=' + this.token).then(function (response) {
          return response.json();
        }).then(function (response) {
          _this.error = "";

          if (response.features !== undefined) {
            var toShow = response.features.slice(0, 6);

            if (toShow.length > 0) {
              _this.geodata = toShow;

              _this.$refs.dropdown.open();
            } else {
              _this.error = _this.$t("maps.field.geolocation.error.empty");

              _this.$refs.dropdown.close();
            }
          } else {
    ...
    selectDropdown: function selectDropdown(selection) {
      delete selection.type;
      this.$refs.dropdown.close();
      this.$emit('input', selection);
    },
    setValue: function setValue(value, key) {
      var writeMsg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      this.error = "";
      var v = {
      ...
      if (this.required && (v.name.length == 0 || v.lat.length == 0 || v.lng.length == 0)) {
        this.error = writeMsg ? this.$t("maps.field.geolocation.error") : "";
        return false;
      }

      if (v.name !== undefined && v.name.length == 0) {
        this.error = writeMsg ? this.$t("maps.field.geolocation.lat.error") : "";
        return false;
      }
      ...
      if (v.lng === undefined || isNaN(v.lng) || Math.abs(v.lng) > 180) {
        this.error = writeMsg ? this.$t("maps.field.geolocation.lng.error") : "";
        return false;
      }
...
exports.default = _default;
        var $e7afbd = exports.default || module.exports;
      
      if (typeof $e7afbd === 'function') {
        $e7afbd = $e7afbd.options;
      }
    
        /* template */
        Object.assign($e7afbd, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "k-field",
    {
      staticClass: "k-geolocation-field",
      attrs: {
        label: _vm.label,
    ...
    [
      _c("k-text-field", {
        ref: "name",
        staticClass: "k-geolocation-search",
        attrs: {
          type: "text",
          theme: "field",
          value: this["search"],
              ...
              return _c(
                ...
                [
                  _c("span", {
                    domProps: {
                      innerHTML: _vm._s(
                        _vm.$t("maps.field.geolocation." + option.type) +
                          ": " +
                          option.name
                      )
                    }
      ...
      _c("k-input", {
        ...
        attrs: {
          ...
          before: _vm.$t("maps.field.geolocation.name")
        },
        on: {
      ...
      _c("k-input", {
        ...
        attrs: {
          ...
          before: _vm.$t("maps.field.geolocation.lat")
        },
        on: {
          input: function($event) {
      ...
      _c("k-input", {
        ...
        attrs: {
          ...
          before: _vm.$t("maps.field.geolocation.lng")
        },
        on: {
          input: function($event) {
      ...
      _vm._v(" "),
      _vm.error
        ? _c("k-box", { attrs: { text: _vm.$t(_vm.error), theme: "negative" } })
        : _vm._e()
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e7afbd', $e7afbd);
          } else {
            api.reload('$e7afbd', $e7afbd);
          }
        }
...
var _Marker = _interopRequireDefault(require("./components/Marker.vue"));

var _Geolocation = _interopRequireDefault(require("./components/Geolocation.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

panel.plugin("microman/map", {
  icons: {
    'marker': '<path d="M7.3,15.6C2.8,9.1,2,8.4,2,6.1c0-3.3,2.7-5.9,5.9-5.9s5.9,2.7,5.9,5.9c0,2.4-0.8,3.1-5.3,9.6C8.3,16.1,7.6,16.1,7.3,15.6L7.3,15.6z M7.9,8.5c1.4,0,2.5-1.1,2.5-2.5S9.3,3.6,7.9,3.6S5.5,4.7,5.5,6.1S6.6,8.5,7.9,8.5z"/>'
  },
  blocks: {
...
},{"./components/Map.vue":"components/Map.vue","./components/Marker.vue":"components/Marker.vue","./components/Geolocation.vue":"components/Geolocation.vue"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
